export default function Hero() {
  return (
    <div className="relative pb-24 lg:pb-40 overflow-hidden">
      <img
      ...
      <img
        ...
        src="https://shuffle.dev/saturn-assets/images/headers/light-blue-left.png"
        alt=""
      ...
      <div className="relative py-8 mb-0 md:mb-20 bg-transparent z-50"></div>
      <div className="relative container px-4 mx-auto z-20">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap -mx-4 items-center">
            <div className="w-full lg:w-2/5 px-4 mb-3 sm:mb-16 lg:mb-0">
              <div className="relative max-w-md mx-auto lg:mx-0">
                <img
                  className="block h-96 md:h-full w-full rounded-2xl shadow-xl"
                  src="/ebook.png"
                  alt="Imagem do ebook"
                />
              </div>
            ...
            <div className="w-full lg:w-3/5 px-4">
              <div className="max-w-md lg:max-w-2xl mx-auto lg:mr-0">
                <div className="max-w-2xl  mb-8 sm:mb-14">
                  <h1 className="font-heading text-5xl xs:text-6xl md:text-8xl xl:text-10xl font-bold text-gray-900">
                    <span>Liberte-se do sofrimento</span>
                  </h1>
                  <span className="text-xl">
                    Descubra quem você é alem dos pensamentos e seja livre
                  </span>
                </div>
      ...
      <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-md z-50">
        ...
        <nav
          className="relative flex flex-col py-6 px-10 w-full h-full bg-white border-r overflow-y-auto"
        ...
        >
          <div className="flex items-center mb-16">
            <a className="mr-auto text-2xl font-medium leading-none" href="#">
              <img
                className="h-10"
                src="https://shuffle.dev/saturn-assets/logos/logo-saturn-dark.svg"
                alt=""
                width="auto"
                data-config-id="auto-img-19-5"
              />
            </a>
          ...
          <div>
            ...
            <div className="py-8 px-6 mb-6 border-t border-b border-gray-200">
              ...
              >
                ...
                <span className="ml-3" data-config-id="auto-txt-28-5">
                  Upgrade to Premium
                </span>
              </a>
            </div>
